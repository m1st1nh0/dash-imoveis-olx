...
def scrape(estado):
    ...
    for i in range(1, 100):
        url = f'https://www.chavesnamao.com.br/api/realestate/listing/items/?level1=casas-a-venda&level2=pr-curitiba&pg={i}&quebra=%5B16378%5D&server=0&viewport=desktop'
